...
export declare enum PayloadPurchaseProviderV2 {
    Google = "google",
    Apple = "apple",
    Paddle = "paddle"
}
...
export declare type PayloadSavePurchasesRequestV2 = PayloadPurchaseBaseV2[];
export declare enum PayloadPurchaseStatusV2 {
    Valid = "valid",
    Expired = "expired",
    Refunded = "refunded",
    Invalid = "invalid"
...
export declare type PayloadPurchaseDataV2 = PayloadPurchaseBaseV2 & ((PurchaseMetaDataApple | PurchaseMetaDataGoogle | PurchaseMetaDataPaddle) | (PurchaseMetaDataAppleInvalid | PurchaseMetaDataGoogleInvalid | PurchaseMetaDataPaddleInvalid));
export declare type PayloadSavePurchasesResponseV2 = PayloadPurchaseDataV2[];
export {};
