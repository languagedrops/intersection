...
(function (PayloadErrorsV4) {
    ...
    PayloadErrorsV4["AutogeneratedUser"] = "Found provider autogenerated";
})(PayloadErrorsV4 = exports.PayloadErrorsV4 || (exports.PayloadErrorsV4 = {}));
const getEventTypeV4 = (error) => {
    switch (error) {
...
exports.getEventTypeV4 = getEventTypeV4;
const getStatusCodeV4 = (error) => {
    switch (error) {
        case PayloadErrorsV4.InvalidUserEmail:
        case PayloadErrorsV4.DuplicateUserEmail:
        case PayloadErrorsV4.InvalidPayload:
...
exports.getStatusCodeV4 = getStatusCodeV4;
const PayloadIsWarningResponseV4 = (error) => exports.getEventTypeV4(error) === 'warning';
exports.PayloadIsWarningResponseV4 = PayloadIsWarningResponseV4;
const PayloadIsErrorResponseV4 = (error) => exports.getEventTypeV4(error) === 'error';
exports.PayloadIsErrorResponseV4 = PayloadIsErrorResponseV4;
